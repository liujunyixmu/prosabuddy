...
export type EventLspClientRocqServerStatus = {
...
export type EventLspClientRocqFileProgress = {
...
export type EventLspClientRocqExecutionInformation = {
...
export type Event =
  ...
  | EventLspClientRocqServerStatus
  | EventLspClientRocqFileProgress
  | EventLspClientRocqExecutionInformation
  | EventLspUpdated
  | EventFileEdited
  | EventMessageUpdated
  | EventMessageRemoved
...
export type LspRocqProgress = {
  path: string
  count: number
}

export type LspRocqExecution = {
  path: string
  range?: Range
}

export type LspRocqCurrent = {
  path: string
  goal?: string
  hyps: Array<string>
  error?: string
...
export type LspRocqStatus = {
  state?: "Busy" | "Idle" | "Stopped"
  modname?: string
  progress: Array<LspRocqProgress>
  execution: Array<LspRocqExecution>
  current?: LspRocqCurrent
}
