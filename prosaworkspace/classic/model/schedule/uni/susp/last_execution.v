    ...
    Section Lemmas.
      ...
      Section ExistsIntermediateExecution.
        ...
        Proof.
          ...
          have BOUNDS: service sched j (job_arrival j) <= s < service sched j t.
          { apply/andP; split.
            - rewrite /service /service_during.
          ...
          have EX := exists_intermediate_point (service sched j) (service_is_a_step_function sched j)
                       (job_arrival j) t ARR_LE s BOUNDS.
