  ...
  Section Task.
    ...
    Section Lemmas.
      ...
      Proof. 
        ...
        -  destruct c; intros H; inversion H; apply C0_.
        -  intros IHSwf. case Hcases:(scheduled_at sched job t); destruct c.
          + by inversion IHSwf; apply C0_.
          + rewrite Hcases in IHSwf. apply IHwf' in IHSwf.
            apply S_C_sched with (c:=c)(e:=e); [apply Hcases | apply IHSwf].
          + by inversion IHSwf; apply C0_.
      ...
      Proof.
        ...
        - destruct H_lt as [delta ht']. rewrite -ht'.
          have SPLIT: \sum_(job_arrival job <= i < t' + delta) service_at sched job i =
                      \sum_(job_arrival job <= i < t') service_at sched job i +
                      \sum_(t' <= i < t' + delta) service_at sched job i
            by apply big_cat_nat; ssromega.
          rewrite SPLIT. ssromega.
      Qed.
