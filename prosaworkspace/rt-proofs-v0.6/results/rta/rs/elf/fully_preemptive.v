...
(** * RTA for Fully Preemptive ELF Scheduling on Restricted-Supply Uniprocessors *)
...
Section RTAforFullyPreemptiveELFModelwithArrivalCurves.
  ...
  (** In order to apply aRSA, we require a bound on the maximum busy-window
      ...
      "recurrence" (i.e., inequality) [SBF L >=
  ...
  Proof.
    ...
    - apply: busy_intervals_are_bounded_rs_elf; try done.
      + exact: instantiated_i_and_w_are_coherent_with_schedule.
      + move=> ?.
...
End RTAforFullyPreemptiveELFModelwithArrivalCurves.
